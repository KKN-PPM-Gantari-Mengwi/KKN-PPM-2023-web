...
const Jogging_Track_Banjar_Tegalnarungan = () => {
  return (
      ...
      <section className="bg-taman-manik-segara w-full h-[735px]">
        <div className="wisataCover1 w-full h-full">
          <div className="block z-0 pt-60 ">
            ...
            >
              Jogging Track Banjar Tegalnarungan
            </h1>
          </div>
        </div>
      </section>
        ...
        <div className="w-full h-full bg-pattern-1">
          <div className=" max-w-[1509px] h-fit bg-[#FAFAFA] mx-auto rounded-[30px] -translate-y-60">
            ...
            <div className="md:px-8 px-2 py-4">
              ...
              >
                Jogging track ini berlokasi di sekitar Kantor Balai Penyuluh
                Pertanian (BPP) Kecamatan Mengwi. Anda dapat menemukan titik
                awal dari jogging track ini di sebelah kiri dari gerbang Kantor
                BPP. Jogging track ini memiliki panjang sekitar 3,2 kilometer.
                Setelah masuk ke area ini, anda akan disambut dengan pesona
                perkebunan bunga gumitir dan bunga pacar. Jika Anda beruntung,
                Anda dapat bertemu dengan kawanan burung kuntul yang seringkali
                mendiami area ini. Waktu yang kami rekomendasikan untuk
                mengunjungi jogging track ini adalah di pagi hari atau di sore
                hari. Pada waktu-waktu tersebut, Anda dapat bertemu dan
                berbincang dengan para petani yang sedang bekerja di ladang. Tak
                hanya untuk olahraga lari, jogging area ini juga cocok untuk
                dipakai bersepeda. Selain itu, area ini seringkali digunakan
                sebagai area untuk bermain layang-layang. Dengan itu, kami
                merekomendasikan Anda untuk membeli layang-layang buatan
                masyarakat lokal di toko setempat.
              </p>
            </div>
...
export default Jogging_Track_Banjar_Tegalnarungan;
