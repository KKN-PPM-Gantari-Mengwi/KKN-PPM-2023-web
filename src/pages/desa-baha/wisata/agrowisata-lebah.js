...
const fasilitas = ["Toilet", "Cafe/rumah makan"];
const galleryImg = [
        ...
        <div className="w-full h-full bg-pattern-1">
          <div className=" max-w-[1509px] h-fit bg-[#FAFAFA] mx-auto rounded-[30px] -translate-y-60">
            ...
            <div className="md:px-8 px-2 py-4">
              ...
              >
                Pada agrowisata lebah ini terdapat peternakan lebah dengan dua
                jenis lebah sehingga menghasilkan dua jenis madu yang berbeda
                pula. Lebah Apis menghasilkan Madu Nyawan sedangkan Lebah
                Klanceng menghasilkan Madu Kele – kele. Madu Nyawan terasa lebih
                manis sedangkan Madu Kele – kele terasa lebih pahit. Madu Nyawan
                dapat dibeli dengan harga Rp. 99,000 dan Madu Kele – kele dengan
                harga Rp. 199,000.
              </p>
            </div>
...
export default Agrowisata_Lebah;
