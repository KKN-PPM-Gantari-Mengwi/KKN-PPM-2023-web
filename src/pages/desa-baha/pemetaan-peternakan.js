...
const Pemetaan_Peternakan = () => {
  const handleImageClick = () => {
    window.open("/images/assets/peta-dummy.svg", "_blank");
  };
  return (
    <DefaultLayout title="Gantari Mengwi 2023">
      <section className="bg-pemetaan-peternakan w-full h-[735px]">
        <div className="wisataCover1 w-full h-full">
          <div className="block z-0 pt-60">
            <h1
              data-aos="fade-right"
              className="flex justify-center items-center text-t-orange my-auto translate-y-6 md:text-8xl text-6xl font-Natural z-0"
            >
              Pemetaan Peternakan
            </h1>
            <h1
...
export default Pemetaan_Peternakan;
